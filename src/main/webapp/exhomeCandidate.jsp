...
<form id="regForm" action="homeCandidateForm" method="POST">
    ...
    <div class="tab">
        ...
        <p><input placeholder="addresse du laboratoire" oninput="this.className = ''" name="nameAddressLaboratory" value="" ></p>
        Sujet de these:
        <p><input placeholder="Sujet de these" oninput="this.className = ''" name="topicPhd"></p>
    ...
    <div class="tab">
        ...
        <p><input type="text" placeholder="nom  addresse" oninput="this.className = ''" value=" " name="nameAddressUniversity"></p>
